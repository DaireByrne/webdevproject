//<!-- code gotten from https://msdn.microsoft.com/en-us/library/hh920769(v=vs.85).aspx   -->
...
function slideShow() {
  ...
  var globals = {
    ...
    buttonStartText: "Start slides to view other tables", // Text used in the slide show toggle button.
    buttonStopText: "Stop slides to view current table", // Text used in the slide show toggle button.    
